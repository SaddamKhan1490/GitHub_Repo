...
object WriteOutput_SaveOutput_AsFile {

  def main(args: Array[String]): Unit = {

    println("Let's write and save content of Spark DataFrame to File...")

    // Create Spark Session
    val sparkSession = SparkSession.builder.master("local").appName("WriteOutput_SaveOutput using Coalesces_Repatition").getOrCreate()
