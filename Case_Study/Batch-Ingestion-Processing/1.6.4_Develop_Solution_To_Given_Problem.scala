...
Idea would be to identify the flights who have common FlightNum and ([source === destination] && [source_departure_time > destination_arrival_time] && [source_departure_time > scheduled_source_departure_time] && [destination_arrival_time > scheduled_destination_arrival_time]
