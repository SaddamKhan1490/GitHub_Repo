...
# Definition of the Hive Table
      ...
      CREATE TABLE prd_fnd_air.summary_stats_2007(
            Year	 string COMMENT '1987-2008',
            Month	 string COMMENT '1-12',
            DayofMonth  string COMMENT	'1-31',
            DayOfWeek	 string COMMENT '1 (Monday) - 7 (Sunday)',
            ...
            ActualElapsedTime	 string COMMENT 'in minutes',
            CRSElapsedTime	 string COMMENT 'in minutes',
            AirTime	 string COMMENT 'in minutes',
            ArrDelay	 string COMMENT 'arrival delay, in minutes',
            DepDelay	 string COMMENT 'departure delay, in minutes',
            Origin	 string COMMENT 'origin IATA airport code',
            Dest	 string COMMENT 'destination IATA airport code',
            Distance	 string COMMENT 'in miles',
            ...
            CarrierDelay	 string COMMENT 'in minutes',
            WeatherDelay	 string COMMENT 'in minutes',
            NASDelay	 string COMMENT 'in minutes',
            SecurityDelay	 string COMMENT 'in minutes',
            LateAircraftDelay	 string COMMENT 'in minutes')
